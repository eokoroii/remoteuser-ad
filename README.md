...
<ol>
  <li>
    ...
    <ol type="a">
      ...
      <p align="center">
        <img src="YOUR_IMAGE_URL_HERE" alt="Logging into Client-1 as jane_admin" width="600" />
        <br /><em>Figure 3.1 – Logged into Client-1 as jane_admin.</em>
      </p>
      <li>
      ...
      <p align="center">
        <img src="YOUR_IMAGE_URL_HERE" alt="Remote Desktop settings on Client-1" width="600" />
      ...
      <p align="center">
        <img src="YOUR_IMAGE_URL_HERE" alt="Adding 'domain users' for Remote Desktop access" width="600" />
  ...
  <li>
    ...
    <ol type="a">
      ...
      <p align="center">
        <img src="YOUR_IMAGE_URL_HERE" alt="Opening PowerShell on DC-1" width="600" />
      ...
      <p align="center">
        <img src="YOUR_IMAGE_URL_HERE" alt="New users created in ADUC" width="600" />
  ...
  <li>
    ...
    <ol type="a">
      ...
      <p align="center">
        <img src="YOUR_IMAGE_URL_HERE" alt="Logging into Client-1 as kid.koxi" width="600" />
      ...
      <p align="center">
        <img src="YOUR_IMAGE_URL_HERE" alt="Verifying user identity via command prompt" width="600" />
